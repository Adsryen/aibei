Page({
  data: {
    token:'24.f86ffebf165f95f9867978aefef73d15.2592000.1679241167.282335-30517478',//刚刚在百度API网页上获取的access_tokne
  ...
  // 点击“译”时，调用translate函数。这里需用调用wx.request来发起 HTTPS 网络请求。
  // 后附wx.request的说明文档。
  translate(){
    console.log(this.data.text);
    wx.request({
      // https://aip.baidubce.com/rpc/2.0/mt/texttrans/v1?access_token= 获取方式见文章的3.（2）
